...
const socket = io('/')
wss.resisterSocketEvents(socket)
...
const strangerChatButton = document.getElementById('stranger_chat_buttons')
const strangerVideoButton = document.getElementById('stranger_video_buttons')
