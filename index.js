...
io.on('connection', socket => {
    ...
    socket.on('stranger-connection-status', data => {
        ...
        if (status) {
            ...
            connectedPeersStrangers = connectedPeersStrangers.filter(peerSocketId => peerSocketId !== socket.id)
        }
    })
    ...
    socket.on('disconnect', () => {
        connectedPeers = connectedPeers.filter((peerSockedId) => peerSockedId !== socket.id)
